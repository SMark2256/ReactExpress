...
const Foods = (props) => {
  ...
  return (
        ...
        <li className="col-12 container ">
              ...
              <img src={props.img} onError={e => { e.currentTarget.src = logo; }} height="150" width="150"/>
              ...
              <div className="iconbutton row justify-content-center"><h2>
                  <button className="heart mx-2"><img src={imgIcon} className="hearticon" onClick={() => iconChange(imgIcon)}/></button>
